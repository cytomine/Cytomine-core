...
class ImageInstanceSecurityTests extends SecurityTestsAbstract{
    ...
    //***********test for locked projects
    void testImageInstanceSecurityForCytomineAdminInLockedProject() {
        getUser1()
        getUserAdmin()
    ...
    void testImageInstanceSecurityForProjectUserInLockedProject() {
    ...
    void testImageInstanceSecurityForSimpleUserInLockedProject() {
