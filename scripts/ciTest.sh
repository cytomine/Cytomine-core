...
containerId=$(docker create --network scripts_default --link nginxTest:localhost-core -v "$PWD"/ci/surefire-reports:/app/target/surefire-reports cytomine/cytomine-core-spring-test )
