...
import be.cytomine.score.ScoringDescriptionService
 ...
 */
class ScoringDescriptionAPI extends DomainAPI {

    static def show(Long id, String className, String username, String password) {
        String URL = Infos.CYTOMINEURL + "api/domain/${className.replace(".","_")}/$id/scoring-description.json"
        return doGET(URL, username, password)
    }

    static def list(String username, String password) {
        String URL = Infos.CYTOMINEURL + "api/scoring-description.json"
        return doGET(URL, username, password)
    }
    ...
    static def create(Long id, String className,String json, String username, String password) {
        ...
        Long descr = JSON.parse(result.data)?.scoringdescription?.id
        return [data: ScoringDescription.get(descr), code: result.code]
    }
